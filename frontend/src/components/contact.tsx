...
function CopyDiv(prop:{email:string,contact:number}):JSX.Element {
    ...
    return (
        ...
        <IconContext.Provider value={{ color: "white", className: "global-class-name" }}>
            ...
            <button onClick={() =>  navigator.clipboard.writeText(prop.email)} className="hover:bg-gray-700 hover:scale-110" >
    ...
    <div className="flex flex-row items-center space-x-5">
        <IconContext.Provider value={{ color: "white", className: "global-class-name" }}>
            ...
            <button onClick={() =>  navigator.clipboard.writeText(prop.contact.toString())} className="hover:bg-gray-700 hover:scale-110" >
            <MdOutlineContentCopy  style={{width:"30px",height:"30px"}} />
            </button>
            </IconContext.Provider>
        </div>
